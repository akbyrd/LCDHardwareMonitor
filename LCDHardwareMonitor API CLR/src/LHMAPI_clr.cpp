...
[Attributes] public interface class ISensorInitialize { b32  Initialize (PluginContext* context, SensorPlugin::InitializeAPI api); };
...
[Attributes] public interface class IWidgetInitialize { b32  Initialize (PluginContext* context, WidgetPlugin::InitializeAPI api); };
