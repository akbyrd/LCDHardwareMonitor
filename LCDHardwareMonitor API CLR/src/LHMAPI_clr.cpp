...
[Attributes] public interface class ISensorPluginInitialize   { b32  Initialize    (PluginContext& context, SensorPluginAPI::Initialize api); };
...
[Attributes] public interface class IWidgetPluginInitialize   { b32  Initialize    (PluginContext& context, WidgetPluginAPI::Initialize api); };
...
[Attributes] public interface class IWidgetInitialize         { b32  Initialize    (PluginContext& context, WidgetAPI::Initialize api); };
